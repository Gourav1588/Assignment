...
/**
 * Utility service responsible for constructing, signing, and parsing JSON Web Tokens.
 */
@Slf4j
@Service
public class JwtService {
    ...
    /**
     * Generates a secure JWT payload containing the user's identity and core claims.
     */
